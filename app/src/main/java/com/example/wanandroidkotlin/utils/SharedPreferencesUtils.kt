 ...
 */
class SharedPreferencesUtils<T>(val name: String, private val default: T) {

    companion object {
        private val fileName = "wan_android"

        private val pref: SharedPreferences by lazy {
            AppApplication.instance.getSharedPreferences(fileName, Context.MODE_PRIVATE)
        }
